...
export const SJKNavbar:React.FunctionComponent<any> = props =>{
    ...
    return (
        <Nav.Col sm={12}>
                ...
                <Nav.Nav className="mr-auto">
                    ...
                    <Nav.Nav.Link href="#link">Link</Nav.Nav.Link>
                ...
                {/*<Nav.Form inline>
                    <Nav.FormControl type="text" placeholder="Search" className="mr-sm-2" />
                    <Nav.Button variant="outline-success">Search</Nav.Button>
                </Nav.Form>*/}
                </Nav.Navbar.Collapse>
            </Nav.Navbar>
        </Nav.Col>
